...
def ask_for_sps():
    ...
    sps_choice = input("Choose an option (1-6, or press Enter to use 200 SPS): ")
    sps_options = [50, 60, 100, 200, 500, 600]
    if sps_choice.isdigit() and 1 <= int(sps_choice) <= 6:
    ...
    try:
        ...
        with open(filename, mode='w', newline='') as file:
            ...
            while count < total_samples:
                ...
                # Multiplica cada valor leido por 5.0
                ADC_Value = [value * 5.0 / 0x7fffff for value in ADC_Value]
                ...
                if display_data and count % 100 == 0:  # Display every 100 samples
                    for i, ch in enumerate(channels):
                        print("Channel %d: %.6f V" % (ch, ADC_Value[i]))
